...
export default function Projects() {
    return (
        ...
        <Container className="py-5 projects-container">
            ...
            <Row className="sm-row-col">
                <Col lg={6} md={12} sm={12} xs={{ order: 2 }} className="order-sm-2 mt-sm-3 mt-lg-5">
                    <img src={recycleImage} alt="recycle page" className="project-image" />
                </Col>
                <Col lg={6} md={12} sm={12} xs={{ order: 1 }} className="order-sm-1 mt-sm-3 mt-lg-5">
                    <h2 className="primary-font fw-600 fs-3 white project-heading-h2">ReCycle</h2>
                    <p className="secondary-font fw-400 text-fs width-90 ">
            ...
            <Row className="sm-row-col">
                <Col lg={6} md={12} sm={12} className="order-sm-1 order-md-1 order-lg-2 mt-sm-3 mt-lg-5">
                    <h2 className="primary-font fw-600 fs-3 white project-heading-h2">Flower Power</h2>
                    <p className="secondary-font fw-400 text-fs width-90">
            ...
            <Row className="sm-row-col">
                <Col lg={6} md={12} sm={12} xs={{ order: 2 }} className="order-sm-2 order-md-2 mt-sm-3 mt-lg-5">
                    <img src={hubspotImage} alt="hubspot page" className="project-image" />
                </Col>
                <Col lg={6} md={12} sm={12} xs={{ order: 1 }} className="order-sm-1 order-md-1 mt-sm-3 mt-lg-5">
                    <h2 className="primary-font fw-600 fs-3 white project-heading-h2">Hubspot</h2>
                    <p className="secondary-font fw-400 text-fs width-90">
            ...
            <Row className="sm-row-col">
                <Col lg={6} md={12} sm={12} className="order-sm-1 order-md-1 order-lg-2 mt-sm-3 mt-lg-5">
                    <h2 className="primary-font fw-600 fs-3 white project-heading-h2">Letha</h2>
                    <p className="secondary-font fw-400 text-fs width-90">
            ...
            <Row className="sm-row-col">
                ...
                <Col lg={6} md={12} sm={12} xs={{ order: 1 }} className="order-sm-1 order-md-1 mt-sm-3 mt-lg-5">
                    <h2 className="primary-font fw-600 fs-3 white project-heading-h2">Community Science Museum</h2>
                    <p className="secondary-font fw-400 text-fs width-90">
            ...
            <Row className="sm-row-col">
                <Col lg={6} md={12} sm={12} className="order-sm-1 order-md-1 order-lg-2 mt-sm-3 mt-lg-5">
                    <h2 className="primary-font fw-600 fs-3 white project-heading-h2">Holidaze</h2>
                    <p className="secondary-font fw-400 text-fs width-90">
                    Final project exam at Noroff. Created in React, server is hosted through Heroku, Strapi API and 
