    ...
    <>
      <Container className="mt-5 main-index-wrapper">
        ...
        <Row className="px-lg-5 px-md">
          <Col md={3} xs={6} className="d-flex flex-row media-align-center">
          ...
          <Col md={3} xs={6} className="d-flex flex-row col-fix-margin media-align-center">
            <div className="align-center">
          ...
          <Col md={3} xs={6} className="d-flex flex-row mt-sm-2 media-align-center">
            <div className="align-center">
